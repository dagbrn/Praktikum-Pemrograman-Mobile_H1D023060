...
import com.example.firstweek.databinding.ActivityHalaman2Binding
...
class Halaman2Activity : AppCompatActivity() {
    ...
    private val packageMap = "com.google.android.apps.maps"
...
//        }
    ...
    private fun initListener(){
        binding.layoutLocation.root.setOnClickListener {
            ...
            startActivity(mapIntent.setPackage(packageMap))
        }
