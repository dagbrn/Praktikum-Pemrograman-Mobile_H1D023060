package com.example.firstweek.viewmodel
...
import com.example.firstweek.data.network.RetrofitInstance
    ...
    fun fetchBooks(query: String){
        viewModelScope.launch {
            try {
                ...
                Log.e("API_EXCEPTION", e.localizedMessage ?: "Unkown Message")
            }
        }
    }
}